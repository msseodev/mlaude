...
describe('PLANNER_AGENT_NAMES', () => {
  it('contains all 7 planner agent names', () => {
  ...
  it('has exactly 7 members', () => {
    expect(PLANNER_AGENT_NAMES.size).toBe(7);
  });
});

describe('isPlannerAgent', () => {
  it('returns true for all 7 planner agents', () => {
    const plannerNames = ['product_designer', 'ux_planner', 'tech_planner', 'biz_planner', 'music_domain_planner', 'planning_moderator', 'smoke_tester'];
